...
export const fetchCurrentMonthEarnings = async (): Promise<CurrentMonthEarningsData | null> => {
  try {
...
export const fetchEarningsHistory = async (): Promise<EarningsHistoryData | null> => {
  try {
