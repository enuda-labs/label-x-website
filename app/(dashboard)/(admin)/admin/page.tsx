...
import { Settings, Users, FolderOpen, Plus } from "lucide-react";
...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="border-b bg-card/30 backdrop-blur supports-[backdrop-filter]:bg-card/60">
            ...
            <Card className="p-6">
              <div className="space-y-6">
                ...
                <Button 
                  ...
                  disabled={!selectedProject || selectedLabelers.length === 0}
                  className="w-full"
                >
                  Assign Selected Labelers to Project
                </Button>
              </div>
            </Card>
          </TabsContent>
