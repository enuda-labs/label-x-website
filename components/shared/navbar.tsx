        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <Link href='/subscriptions'>
            <button
                  ...
                  className="block text-white hover:text-orange-500  px-3 py-2 rounded-md text-base font-medium text-center"
                >
                Get Started
                </button>
                </Link>
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <div className="pt-2">
               <Link href='/subscriptions'>
                <button
                  onClick={handleScrollToPartner}
                  className="block w-full  hover:text-orange-500 text-white px-3 py-3 rounded-md text-base font-medium text-center"
                >
                 Get Started
                </button>
                </Link>
